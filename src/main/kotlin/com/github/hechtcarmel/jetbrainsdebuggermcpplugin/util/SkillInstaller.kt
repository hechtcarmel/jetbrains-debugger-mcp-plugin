 ...
 *
 * The skill files are bundled as JAR resources under /skill/jetbrains-debugger/.
...
object SkillInstaller {
     ...
     * Creates the directory structure: targetDir/jetbrains-debugger/SKILL.md, etc.
     *
     ...
     * The zip contains: jetbrains-debugger/SKILL.md, jetbrains-debugger/references/tool-reference.md
     *
