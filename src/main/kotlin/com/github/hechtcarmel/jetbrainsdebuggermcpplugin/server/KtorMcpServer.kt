 ...
 *    - POST /debugger-mcp/streamable-http → JSON-RPC with Mcp-Session-Id header
 *    - GET  /debugger-mcp/streamable-http → 405 Method Not Allowed
 ...
 *    - POST /debugger-mcp?sessionId=xxx → JSON-RPC messages, response sent via SSE
 *
...
class KtorMcpServer(
    ...
    /**
     * Handles GET /debugger-mcp/sse - Opens SSE stream.
     */
    ...
    /**
     * Handles POST /debugger-mcp - JSON-RPC requests (legacy).
     */
    ...
    /**
     * Handles POST in stateless HTTP mode (no sessionId).
    ...
    /**
     * Handles POST /debugger-mcp/streamable-http — Streamable HTTP transport (MCP 2025-03-26).
     */
    ...
    /**
     * Handles DELETE /debugger-mcp/streamable-http — Session termination.
     */
