...
import com.github.hechtcarmel.jetbrainsdebuggermcpplugin.util.SkillInstaller
 ...
 * that guides AI coding agents on using debugger MCP tools effectively.
 *
...
class InstallSkillAction : AnAction() {
    ...
    private fun saveAsFile(project: Project?, extension: String) {
        val descriptor = FileSaverDescriptor(
            ...
            "Save the Debugger MCP companion skill",
            extension
        )

        val dialog = FileChooserFactory.getInstance().createSaveFileDialog(descriptor, project)
        val wrapper = dialog.save(null as VirtualFile?, "jetbrains-debugger")
